...
class TestCourseSearchTool:
    ...
    def test_execute_with_course_filter(
        ...
        mock_vector_store.search.assert_called_once_with(
            query="algorithms", course_name="ML Course", lesson_number=None
        )
    ...
    def test_execute_with_both_filters(
        ...
        result = course_search_tool.execute(
            "AI", course_name="ML Course", lesson_number=1
        )

        mock_vector_store.search.assert_called_once_with(
            query="AI", course_name="ML Course", lesson_number=1
        )
    ...
    def test_execute_empty_results_with_both_filters(
        ...
        result = course_search_tool.execute(
            "test", course_name="Physics", lesson_number=2
        )
    ...
    def test_source_fallback_to_course_link(
        self, course_search_tool, mock_vector_store, sample_search_results
    ):
