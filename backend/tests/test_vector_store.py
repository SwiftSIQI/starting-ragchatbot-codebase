...
class TestVectorStore:
    ...
    def test_search_with_course_filter(self, vector_store):
        ...
        assert content_search_call[1]["where"] == {"course_title": "Machine Learning Course"}
    ...
    def test_add_course_content(self, vector_store, sample_chunks):
        ...
        assert call_args[1]["metadatas"][0]["course_title"] == "Introduction to Machine Learning"
